...
import com.company.project.aliyun.util.ALiyunIotX509TrustManager;
import com.company.project.aliyun.util.LogUtil;
import com.company.project.aliyun.util.SignUtil;
...
public class IotTestClient {
     ...
     * @param deviceName
     * @param deviceSecret
     * @param jsonObject 如果为空则激活设备，json对象则上传数据
     * @throws Exception
     */
    public void runTestDevice(String productKey, String deviceName, String deviceSecret,
        ...
        connectMqtt(targetServer, mqttclientId, mqttUsername, mqttPassword, productKey, deviceName, jsonObject);
    }

    private void connectMqtt(String url, String clientId, String mqttUsername,
                             String mqttPassword, String productKey, String deviceName,
                             JSONObject jsonObject) throws Exception {
